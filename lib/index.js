/*!
 * vue-virtual-scroll-list v0.1.0
 * open source under the MIT license
 * undefined
 */

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('core-js/modules/es.function.name.js'), require('core-js/modules/es.object.keys.js'), require('core-js/modules/es.symbol.js'), require('core-js/modules/es.array.filter.js'), require('core-js/modules/es.object.get-own-property-descriptor.js'), require('core-js/modules/web.dom-collections.for-each.js'), require('core-js/modules/es.object.get-own-property-descriptors.js'), require('core-js/modules/es.number.constructor.js'), require('core-js/modules/es.array.includes.js'), require('core-js/modules/es.string.includes.js'), require('core-js/modules/es.array.splice.js'), require('core-js/modules/es.array.find-index.js'), require('core-js/modules/es.array.map.js'), require('core-js/modules/es.array.concat.js'), require('core-js/modules/es.symbol.description.js'), require('core-js/modules/es.object.to-string.js'), require('core-js/modules/es.symbol.iterator.js'), require('core-js/modules/es.string.iterator.js'), require('core-js/modules/web.dom-collections.iterator.js'), require('core-js/modules/es.array.from.js'), require('core-js/modules/es.array.slice.js'), require('core-js/modules/es.map.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.split.js'), require('core-js/modules/es.string.replace.js')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.function.name.js', 'core-js/modules/es.object.keys.js', 'core-js/modules/es.symbol.js', 'core-js/modules/es.array.filter.js', 'core-js/modules/es.object.get-own-property-descriptor.js', 'core-js/modules/web.dom-collections.for-each.js', 'core-js/modules/es.object.get-own-property-descriptors.js', 'core-js/modules/es.number.constructor.js', 'core-js/modules/es.array.includes.js', 'core-js/modules/es.string.includes.js', 'core-js/modules/es.array.splice.js', 'core-js/modules/es.array.find-index.js', 'core-js/modules/es.array.map.js', 'core-js/modules/es.array.concat.js', 'core-js/modules/es.symbol.description.js', 'core-js/modules/es.object.to-string.js', 'core-js/modules/es.symbol.iterator.js', 'core-js/modules/es.string.iterator.js', 'core-js/modules/web.dom-collections.iterator.js', 'core-js/modules/es.array.from.js', 'core-js/modules/es.array.slice.js', 'core-js/modules/es.map.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.split.js', 'core-js/modules/es.string.replace.js'], factory) :
